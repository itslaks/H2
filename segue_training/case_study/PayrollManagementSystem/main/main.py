    ...
    while True:
        ...
        if choice == 1:
            ...
            if emp:
                ...
                raise ApplicationException("Employee Not Found.")
    ...
    while True:
        ...
        if choice == 1:
            ...
            if pay:
                ...
                raise ApplicationException("Payroll Not Found.")
    ...
    while True:
        ...
        if choice == 1:
            ...
            if tax:
                ...
                raise ApplicationException("Tax Record Not Found.")
    ...
    while True:
        ...
        if choice == 1:
            ...
            if fr:
                ...
                raise ApplicationException("Financial Record Not Found.")
